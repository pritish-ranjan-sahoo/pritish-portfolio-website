      ...
      <RevealOnScroll>
        <div className="text-center z-10 px-4">
          ...
          <div className="flex justify-center space-x-4">
            <a
              href="#projects"
              className="flex justify-center items-center bg-blue-500 text-white text-lg py-3 px-6 rounded font-medium transition relative overflow-hidden hover:-translate-y-0.5 hover:shadow-[0_0_15px_rgba(59, 130, 246, 0.4)]"
            >
              View Projects
            </a>

            <a
              href="/src/assets/Resume_Pritish.pdf"
              target="_blank"
            ...
            ><span className="text-xl font-extralight" >&#8595;</span>My Resume</a>
          </div>
        </div>
      </RevealOnScroll>
    </section>
